...
export const project2: PortfolioProject = {
	...
	highlights: [
		...
		{ stat: "02", heading: "The approach", blurb: "More details about the design and development process coming soon." },
		{ stat: "03", heading: "The outcome", blurb: "More details about the results and lessons learned coming soon." },
	],
	sections: [
		...
		{ heading: "The finishing touches", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus eget velit at erat tincidunt consequat. Sed dignissim nibh vel libero facilisis, vitae interdum lorem posuere." },
	],
};
